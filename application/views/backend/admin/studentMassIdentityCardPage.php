<style>
    ...
    <div class="row">
        ...
        <?php $student_info = $this->db->get_where('student', array('class_id'=> $class_id))->result_array();
        ...
        <div class="id-card-holder">
            <div class="id-card">
                ...
                <div class="qr-code">
                    <img style="-webkit-user-select: none; width: 100px; height:30px; background-position: 0px 0px, 10px 10px;background-size: 20px 20px; 
                    background-image:linear-gradient(45deg, #eee 25%, transparent 25%, transparent 75%, #eee 75%, #eee 100%),linear-gradient(45deg, #eee 25%, white 25%, white 75%, #eee 100%);" 
                ...
                <p><?php echo $this->db->get_where('settings', array('type' => 'system_email'))->row()->description;?></p>
